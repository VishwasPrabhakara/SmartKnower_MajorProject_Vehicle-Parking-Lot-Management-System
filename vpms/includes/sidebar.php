                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-table"></i><a>Heavy Duty Vehicle</a></li>
                            <li><i class="fa fa-table"></i><a>Four Wheeler Vehicle</a></li>                            
                            <li><i class="fa fa-table"></i><a>Two Wheeler Vehicle</a></li>
                        </ul>
                    </li>
                    <li>
